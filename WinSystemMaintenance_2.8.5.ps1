# WinSystemMaintenance_2.8.5.ps1
...
# Changes in 2.8.5:
# - Fixed Contig command by escaping the dollar sign in the MFT path ("\$mft" -> "\`$mft") to prevent PowerShell variable expansion.
# - Updated logging and console output to reflect the escaped path for accuracy.
