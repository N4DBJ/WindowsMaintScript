...
# Description: Added timeout (1 hour) and stalled progress detection (no change for 10 min) for DISM /restorehealth to prevent hangs.
...
#              Added script version display at start.
#              Fixed DISM command execution error in OS Maintenance Section by updating $osCommands to store only arguments for DISM and adjusting Start-Process.
...
Write-Host "Script Version: 2.5.7" -ForegroundColor Cyan
